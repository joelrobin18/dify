...
class Template:
    ...
    def get_variable_selectors(self) -> list[Sequence[str]]:
        """Get all variable selectors in the template.

        Returns:
            List of variable selectors
        """
        return [segment.selector for segment in self.segments if isinstance(segment, VariableSegment)]
